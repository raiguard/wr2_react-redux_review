  ...
  render() {
    return (
      <section className="button-control">
        <input value={this.state.numAmount} onChange={this.handleInput} />
        <div className="buttons">
          <button name="decrease" onClick={this.handleSubmit}>
            DECREASE
          </button>
          <button onClick={this.handleSubmit}>CLEAR</button>
          <button name="increase" onClick={this.handleSubmit}>
            INCREASE
          </button>
        </div>
      </section>
